...
Baseline_data_v5_sub<-Baseline_data_v5 %>% select("ADM_GWAS3_COM","entity_id","SEX_ASK_COM", "AGE_NMBR_COM", "HWT_DBMI_COM", "BLD_CHOL_COM", "BLD_CREAT_COM",
                                                  "DXA_HIPL_HTOT_BMD_COM", "DXA_HIPR_HTOT_BMD_COM","BLD_ALC24_HR_COM","BLD_ALC24_MIN_COM", "BLD_FD24_HR_COM", "BLD_FD24_MIN_COM")
colnames(Baseline_data_v5_sub)<-c("ADM_GWAS_COM","entity_id","SEX_ASK_COM", "AGE_NMBR_COM", "HWT_DBMI_COM", "BLD_CHOL_COM", "BLD_CREAT_COM", 
                                  "DXA_HIPL_HTOT_BMD_COM", "DXA_HIPR_HTOT_BMD_COM","BLD_ALC24_HR_COM","BLD_ALC24_MIN_COM", "BLD_FD24_HR_COM", "BLD_FD24_MIN_COM")
